...
```html
<div className="dropdown">
  <label className="btn my-2" tabindex="0">Click</label>
  <div className="dropdown-menu">
    <a className="dropdown-item text-sm">Profile</a>
...
<div className="flex gap-2 justify-center">
  <div className="dropdown">
  <label className="btn mx-2" tabIndex="0">Click</label>
...
<div className="dropdown">
  <label className="btn my-2" tabindex="0">Click</label>
  <div
    className="dropdown-menu dropdown-menu-bottom-right border border-gray-500"
  >
    <a className="dropdown-item text-sm">Profile</a>
    <a tabindex="-1" className="dropdown-item text-sm">Account settings</a>
    <a tabindex="-1" className="dropdown-item text-sm"> Subscriptions</a>
...
<div className="flex justify-center">
  <div className="dropdown">
    ...
    <div className="dropdown-menu dropdown-menu-bottom-right gap-1">
      ...
      <a tabIndex="-1" className="dropdown-item dropdown-active text-sm">
        {" "}
        Subscriptions
      </a>
    </div>
...
<div className="dropdown">
  ...
  <div className="dropdown-menu dropdown-menu-bottom-right gap-1">
    <a className="dropdown-item text-sm">Profile</a>
    <a tabindex="-1" className="dropdown-item text-sm">Account settings</a>
    <a tabindex="-1" className="dropdown-item text-sm dropdown-active">
      Subscriptions</a
    >
  </div>
</div>
