...
<div className="skeleton skeleton-pulse h-24"></div>
...
<table className="table w-full max-w-4xl">
    <thead>
        <tr>
        <th><div className="skeleton skeleton-pulse h-5 rounded-md"></div></th>
        <th><div className="skeleton skeleton-pulse h-5 rounded-md"></div></th>
        <th><div className="skeleton skeleton-pulse h-5 rounded-md"></div></th>
        <th><div className="skeleton skeleton-pulse h-5 rounded-md"></div></th>
        </tr>
    ...
    <tbody>
        <tr>
        <th><div className="skeleton skeleton-pulse h-5 rounded-md"></div></th>
        <td><div className="skeleton skeleton-pulse h-5 rounded-md"></div></td>
        <td><div className="skeleton skeleton-pulse h-5 rounded-md"></div></td>
        <td><div className="skeleton skeleton-pulse h-5 rounded-md"></div></td>
        </tr>
        <tr>
